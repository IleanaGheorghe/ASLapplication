...
public class AnimaleActivity extends BaseActivity {

    private static final String IMAGES_URL="http://ileanadaniela19.000webhostapp.com/Animale/getAnimale.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView=(WebView) findViewById(R.id.wvAnimaleA);
        textView=(TextView)findViewById(R.id.tvAnimaleA);
